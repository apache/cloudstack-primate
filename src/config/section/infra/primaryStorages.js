...
export default {
  ...
  details: ['name', 'id', 'ipaddress', 'type', 'scope', 'path', 'provider', 'hypervisor', 'overprovisionfactor', 'disksizetotal', 'disksizeallocated', 'disksizeused', 'clustername', 'podname', 'zonename', 'created', 'tags'],
  related: [{
    name: 'volume',
    title: 'Volumes',
    param: 'storageid'
