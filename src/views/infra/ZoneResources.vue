  ...
  methods: {
    ...
    returnCapacityTitle (type) {
      switch (type) {
        ...
        case 10: return this.$t('label.routing.host')
        case 11: return this.$t('label.menu.storage')
        case 12: return this.$t('label.usage.server')
        case 13: return this.$t('label.management.server')
        case 14: return this.$t('label.domain.router')
        case 15: return this.$t('label.console.proxy')
        case 16: return this.$t('label.user.vm')
        case 17: return this.$t('label.vlan')
        case 18: return this.$t('label.secondary.storage.vm')
