...
<template>
  <div class="form-layout">
    <a-form
      ...
      <a-row :gutter="12">
        <a-col :md="24" :lg="24">
          <a-form-item :label="$t('usageinterface')">
            <a-input
      ...
      <a-row :gutter="12">
        <a-col :md="12" :lg="12">
          <a-form-item :label="$t('publicnetwork')">
            <a-input
        ...
        <a-col :md="12" :lg="12">
          <a-form-item :label="$t('privatenetwork')">
            <a-input
      ...
      <a-row :gutter="12">
        <a-col :md="12" :lg="12">
          <a-form-item :label="$t('patp')">
            <a-input
              v-decorator="['patp']" />
          </a-form-item>
        </a-col>
        <a-col :md="12" :lg="12">
          <a-form-item :label="$t('palp')">
            <a-input
              v-decorator="['palp']" />
          </a-form-item>
        </a-col>
