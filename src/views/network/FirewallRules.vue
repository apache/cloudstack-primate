  ...
  <div>
    <div>
      <div class="form">
        ...
        <div class="form__item" style="margin-left: auto;">
          <a-button :disabled="!('createFirewallRule' in $store.getters.apis)" type="primary" @click="addRule">{{ $t('add') }}</a-button>
        </div>
      </div>
    </div>
    ...
    <a-modal title="Edit Tags" v-model="tagsModalVisible" :footer="null" :afterClose="closeModal">
      <div class="add-tags">
        ...
        <a-button type="primary" :disabled="'createTag' in $store.getters.apis" @click="() => handleAddTag()" :loading="addTagLoading">{{ $t('add') }}</a-button>
      </div>
